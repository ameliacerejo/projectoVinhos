<%@ Page Title="" Language="C#" MasterPageFile="~/primeira.Master" AutoEventWireup="true" CodeBehind="editarVinho.aspx.cs" Inherits="projectoVinhos.utilizador.editarVinho" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Alterar Vinho</title>
    <style>
        table {
            width: 1000px;
            margin-left: auto;
...
<h1 class="text-center">Alterar Vinho</h1>
    <table class="w-50">
            <tr>
            ...
            <tr>
                <td class="text-center" colspan="2">
                    ...
                    <asp:Button Text="Alterar Vinho" runat="server" ID="buttonAlterarVinho" style="margin-left: 30px"
                        OnClick="buttonAlterarVinho_Click" />
